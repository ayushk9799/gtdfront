      ...
      <ScrollView>
        <View style={styles.content}>
          ...
          <Text style={styles.p}>
            ...
            children under 13 where required by local laws.
          </Text>
          ...
          <Text style={styles.h2}>8. In-App Purchases</Text>
          <Text style={styles.p}>
            We offer in-app purchases and subscriptions that are processed securely
            through Google Play Billing / Apple App Store Payments and managed using RevenueCat.
            We do not store or have access to your full payment details such as credit or debit card numbers.
          </Text>
          <Text style={styles.p}>
            RevenueCat may collect information related to purchase history (such as subscription status
            or transaction identifiers) to enable subscription management and access to premium features.
            For more details on RevenueCat’s privacy practices, please review their privacy policy on their website.
          </Text>

          <Text style={styles.h2}>9. Push Notifications</Text>
          <Text style={styles.p}>
            We use Firebase Cloud Messaging (FCM) to send push notifications related to updates,
            reminders, or other app-related information. Firebase may collect device-level identifiers
            (such as a device token) needed to deliver notifications.
          </Text>
          <Text style={styles.p}>
            You can disable notifications at any time through your device settings. We do not use notifications
            for marketing without your permission, and we do not share notification data with third parties.
          </Text>

          <Text style={styles.h2}>Third-Party Service Providers</Text>
          <Text style={styles.p}>We use the following third-party tools to support core app features:</Text>
          <View style={styles.ul}>
            <Text style={styles.li}>RevenueCat – Subscription and purchase management</Text>
            <Text style={styles.li}>Firebase Cloud Messaging – Push notifications</Text>
            <Text style={styles.li}>Google Sign-In – Authentication</Text>
          </View>
          <Text style={styles.p}>
...
const styles = StyleSheet.create({
  ...
  ul: { marginBottom: 10 },
  li: { fontSize: 16, lineHeight: 24, color: '#333', marginLeft: 20, marginBottom: 5 },
